...
export default function KeystonePage({ onBack, setupOnly, hideCredentials = false, hideTest = false }: KeystonePageProps) {
      ...
      <div className="flex-1">
        {showBackButton && (
          <div className="p-4">
            ...
            >
              <span className="text-xl">{KEYSTONE_ICON}</span>

...
CWR can also download its catalog via FTP. Use **Set Ftp Credential** to provide your FTP username, password and port. The tool connects to `edi.cwrdistribution.com` and downloads `catalog.csv` from the `/out` folder showing progress.
